                                ...
                                @endif
                                  ...
                                  <div class="col-md-6 mt-5">
                                    <div class="input-group">
                                      <input type="text" class="form-control" placeholder="Search crafts or products" aria-label="Search">
                        ...
                        <div class="modal fade" id="deleteModal{{ $product->ProductID }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
                                  <div class="modal-dialog">
                                      <div class="modal-content">
                                          ...
                                          <div class="modal-footer">
                                              <form id="delete-form-{{ $product->ProductID }}" action="{{ route('products.destroy', ['product' => $product->ProductID]) }}" method="POST">
                                                  @csrf
                                                  @method('DELETE')
                              ...
                              <div class="modal-dialog modal-dialog-centered">
                                  <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                          ...
                                          <form method="post" action="{{ route('products.update', ['product' => $product->ProductID]) }}" enctype="multipart/form-data">
                                              @csrf
                                              @method('put')
...
<div class="modal fade" id="saveModal" tabindex="-1" aria-labelledby="saveModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title fs-5" id="saveModalLabel">Save changes?</h2>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <!-- Change the data-target to successModal -->
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#successModal">Yes</button>
...
<!-- JavaScript to trigger the modals -->
<script>
    ...
    // Function to handle form submission and trigger the save modal
...
<div class="container custom-shadow mt-5 p-3">
  <div class="row">
    <div class="col-12">
      <br>
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi vero in quidem!</p>
...
<div class="container custom-shadow mt-5 p-3 mb-5">
  <div class="row">
    <div class="col-12">
      <br>
      <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. In, eius? Repudiandae iste consectetur assumenda.</p>
      <p class="text-muted">- Jane Dela Guzman </p>
    </div>
  </div>
</div>
