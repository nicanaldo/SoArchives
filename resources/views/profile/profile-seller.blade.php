...
<head>
    ...
    <title>Seller | {{ $user->fname }} {{ $user->lname }} </title>
    ...
    <div class="container-fluid custom-shadow">
        ...
        <div id="profile-seller-content">
            ...
            <div class="name text-center">
                ...
                <div class="pb-5">
                    <a href="{{ route('chatify') }}" class="btn button-primary btn-rounded me-1" data-mdb-ripple-init>
                                            ...
                                            <li>
                                                <a class="dropdown-item" href="#">
                                                    <input type="checkbox" name="tags[]"
                                                        value="{{ $tag->name }}" class="form-check-input me-2">
                                                    {{ $tag->name }}
                                                </a>
                                            </li>
                                        @endforeach
                                                                ...
                                                                <form method="post"
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="file" class="form-control"
                                                                            ...
                                                                            accept="image/*" name="PImage[]" multiple>
                                                                    </div>
                            ...
                            <div class="tab-pane fade show" id="pills-archives" role="tabpanel"
                                ...
                                <div class="row justify-content-left" style="margin-top: 3rem;">
                                    ...
                                    @foreach ($archivedProducts as $product)
                                        ...
                                        <div class="modal fade" id="archivedProductModal{{ $product->ProductID }}"
                                            tabindex="-1"
