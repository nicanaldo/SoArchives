    ...
    <div class="container-fluid custom-shadow">
        ...
        <div class="container mt-5 mb-5 " style="padding: 2rem;">
            ...
            <div class="row">
                    ...
                    <div class="custom-shadow p-4 d-flex flex-wrap justify-content-center rounded-2">
                        ...
                        <div class="d-flex flex-wrap justify-content-center">
                            @foreach ($selectedTags as $tag)
                                <button type="button" class="btn btn-sm btn-primary mb-2 me-2"
                                    disabled>{{ $tag }}</button>
                            @endforeach
                        </div>
                    ...
                    <div class="custom-shadow p-4 rounded-2">
                        ...
                        <div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show" id="pills-events" role="tabpanel"
                                                            ...
                                                            <div class="position-absolute top-0 end-0 p-3">
                                                                <div class="dropdown-bar">
                                                                    ...
                                                                    <ul class="dropdown-menu dropdown-menu-end"
                                                                        ...
                                                                        <li>
                                                                            <button class="dropdown-item delete-event"
                                                                                data-bs-toggle="modal"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div
                                                                ...
                                                                @if ($event->Link)
                                                                    <a href="{{ $event->Link }}"
                                                                        class="btn btn-primary-link" target="_blank">
                                ...
                                @foreach ($events as $event)
                                    <div class="modal fade" id="editEventModal{{ $event->EventID }}" tabindex="-1"
                                        aria-labelledby="editEventModalLabel{{ $event->EventID }}" aria-hidden="true"
                                        data-bs-backdrop="static" data-bs-keyboard="false">
                                                    ...
                                                    <form action="{{ route('events.update', $event->EventID) }}"
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="eventName" class="form-label">Event
                                                                Name</label>
                                                            <input type="text" class="form-control" id="eventName"
                                                                name="EName" value="{{ $event->EventName }}">
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <label for="eventStartTime" class="form-label">Start
                                                                    Time</label>
                                                                <input type="time" class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-5">
                                        <button type="button" class="btn btn-warning btn-add-buttons"
                                            data-bs-toggle="modal" data-bs-target="#eventModal"><i
                                                class="fa fa-plus-circle me-2"></i> Create an event</button>
                                        {{-- <button type="button" class="btn btn-primary btn-add-buttons" data-bs-toggle="modal"
                 data-bs-target="#exampleModal">Create an event</button> --}}
                                    </div>
                                                    ...
                                                    <form id="eventForm" method="POST"
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="file" class="form-control"
                                                                id="EventImage" name="EventImage" accept="image/*"
                                                                required>
                                                            <div class="invalid-feedback">Please upload a banner for
                                                                the event.</div>
                                                            <p class="text-muted">Accepted image formats: .jpeg, .jpg,
                                                                .png, with a maximum size of 2MB per image.
                                                                <br>Recommended image size: 1905px x 600px
                                                            </p>
                                                        </div>
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <input type="time" class="form-control"
                                                                    id="StartTime" name="StartTime" required>
                                                                <div class="invalid-feedback">Please provide the start
                                                                    time.</div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <label for="end-time" class="form-label">End
                                                                ...
                                                                <input type="time" class="form-control"
                                                                    id="EndTime" name="EndTime" required>
                                                                <div class="invalid-feedback">Please provide the end
                                                                    time.</div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="url" class="form-control"
                                                                    id="Link" name="Link" required
                                                                    placeholder="Link">
                                                                <div class="invalid-feedback">Please provide a link for
                                                                    registration.</div>
                                                            </div>
                                                        </div>
                                                        <div
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-7 text-center mb-2">
                                                            <img src="{{ asset('storage/' . $event->EventImage) }}"
                                                                ...
                                                                style="height: 400px; object-fit: relative;">
                                                        </div>


                                                        <div class="col-md-5">
                                                            <h5 class="modal-title">{{ $event->EventName }}</h5>
                                                            <p class="modal-text">Description: <br>
                                                                {{ $event->EventDescription }}</p>
                                                            ...
                                                            @if ($event->Link)
                                                                <div class="col-md-12">
                                                                    ...
                                                                    @php
                                                                        ...
                                                                        $eventEndDate = \Carbon\Carbon::parse(
                                                                            $event->Date . ' ' . $event->EndTime,
                                                                        );
                                                                    @endphp
                                                                    @if ($event->Status === 'Ended' || $now->greaterThan($eventEndDate))
                                                                        <div class="card-body">
                                                                            <a href="{{ route('gallery.showEventImages', ['eventId' => $event->EventID]) }}"
                                                                                class="btn btn-primary">
                                                                                View Gallery
                                                                            </a>
                                                                        </div>
                                                ...
                                                <div class="modal-footer">
                                                    @if (Auth::id() == $event->UserID)
                                                        ...
                                                        @else
                                                            ...
                                                            <button type="button" class="btn btn-secondary"
                                                                data-bs-dismiss="modal" data-bs-toggle="modal"
                                                                data-bs-target="#noteditedEventModal{{ $event->EventID }}">
                                                                <i class="fas fa-edit"></i>
                                                            </button>
                                                        @endif
                                ...
                                @foreach ($events as $event)
                                    <div class="modal fade" id="editEventModal{{ $event->EventID }}"
                                        tabindex="-1" aria-labelledby="editEventModalLabel{{ $event->EventID }}"
                                        aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-body">
                        ...
                        <!-- Modal for Editing Events -->
                        <div class="modal fade" id="noteditedEventModal{{ $event->EventID }}" tabindex="-1"
                            aria-labelledby="noteditedEventModal{{ $event->EventID }}" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <div class="modal-body">
                                        <div style="text-align: center;">
                                            <h1 for="header" class="form-name fs-5">You are not allowed to Edit
                                                Event</h1>
                                        </div>
                                        <button type="button" class="btn btn-secondary"
                ...
                <!-- Confirmation Modal for Deleting Event -->
                <div class="modal fade" id="confirmDeleteModal{{ $event->EventID }}" tabindex="-1"
                    aria-labelledby="confirmDeleteModalLabel{{ $event->EventID }}" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="confirmDeleteModalLabel{{ $event->EventID }}">Confirm
                                    Delete</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
