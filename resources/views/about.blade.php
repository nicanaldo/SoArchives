...
<body>
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
            <div class="col about-card">
                <div class="card h-100 border-0 custom-shadow">
                    <img src="{{ asset('images/jenn.png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100 border-0 custom-shadow">
                    <img src="{{ asset('images/naldo.png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100 border-0 custom-shadow">
                    <img src="{{ asset('images/kylie.jpg') }}" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100 border-0 custom-shadow">
                    <img src="{{ asset('images/abbeyA.png') }}" class="card-img-top" alt="...">
                    <div class="card-body">
    ...
    <div class="about-title" style="margin-top: 7rem;">
        ...
        <p class="text-center mb-5">We developed this project to give recognitions to the artisans of Adamson University
        </p>
    </div>
            ...
            <div class="col">
                <div class="card mb-3 border-0 custom-shadow">
                    <div class="card-body p-4">
                        ...
                        <p class="card-text">At our core, we are committed to celebrating and promoting the art of
                            artisanal craftsmanship. We strive to provide a supportive and inspiring environment where
                            artisans can showcase their talents, connect with a community that values their work, and
